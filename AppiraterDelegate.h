...
@optional
-(void)appiraterDidDisplayPreliminaryAlert:(Appirater *)appirater;
-(void)appiraterDidDeclinePreliminaryAlert:(Appirater *)appirater;
-(void)appiraterDidAcceptPreliminaryAlert:(Appirater *)appirater;
